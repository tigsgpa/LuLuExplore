    ...
    const fetchRestaurants = async () => {
      try {
        ...
        const sortingOrders = {
          ...
          "Bread" : ["Vasanta Bhavan", "North Express", "Paragon", "Nagas", "Vaiga's Oottupura"],
          ...
          "Desserts" : ["Amul Ice Creams", "Ice Cream Chef", "Baskin Robbins", "Cold Stone Creamery", "My Fryoland", "The Muffin House", "Mc' Donald", "Burger King"],
          "Pizza" : [ "Pizza Hut","Dominos","Pizza Ricotta"],
          "Pulao" : ["Vasanta Bhavan", "North Express", "Paragon"],   
          "Soup" : ["Rice & Noodles", "Barbeque Nation", "Wow! China", "Halais",  "North Express", "Paragon", "Hottey Smokey", "Flame N & Go", "Vasanta Bhavan"],
          ...
          "Tea" : ["Chai-Chai", "Selfie Tea", "Vaiga's Oottupura", "Ovenly", "Vasanta Bhavan", "Halais"],
          "North Indian" : ["North Express", "Barbeque Nation"],
          "South Indian" : ["Vasanta Bhavan", "Vaiga's Oottupura", "Halais", "Dindugal Thalappakkatti"],
          "Mexican" : ["Tacobell"],
